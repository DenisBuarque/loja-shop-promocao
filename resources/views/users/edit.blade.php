                    ...
                    <div class="md:grid md:grid-cols-3 md:gap-6">
                        ...
                        <div class="md:col-span-1">
                            <div class="px-4 sm:px-0">
                                <h3 class="text-lg font-medium leading-6 text-gray-900">Alterar Usuário</h3>
                                <p class="mt-1 text-sm text-gray-600">Atualize os dados do usuário cadastrado sistema, os compos com (*) são de preenchimento obrigatório.</p>
                            </div>
                        </div>
                                    ...
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <x-jet-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$user->name" maxlength="30" autofocus />
                                                @error('name')
                                            ...
                                            <div>
                                                ...
                                                <x-jet-input id="email" class="block mt-1 w-full" type="email" name="email" :value="$user->email" maxlength="50" />
                                                @error('email')
                                                    <div class="text-red-600">{{$message}}</div>
                                                @enderror
                                            </div>
